...
def cfid(y_true, y_predict, x_true, embeding=no_embedding, estimator=sample_covariance):
    ...
    c_y_true_given_x_true    = с_y_true_y_true       - tf.matmul(с_y_true_x_true, tf.matmul(inv_с_x_true_x_true,с_x_true_y_true))
    c_y_predict_given_x_true = с_y_predict_y_predict - tf.matmul(с_y_predict_x_true, tf.matmul(inv_с_x_true_x_true, c_x_true_y_predict))
    ...
    c_dist1 = tf.linalg.trace(tf.matmul(tf.matmul(c_y_true_x_true_minus_c_y_predict_x_true, inv_с_x_true_x_true), c_x_true_y_true_minus_c_x_true_y_predict))
    c_dist2 = tf.linalg.trace(c_y_true_given_x_true + c_y_predict_given_x_true) - 2*trace_sqrt_product(c_y_predict_given_x_true, c_y_true_given_x_true)
